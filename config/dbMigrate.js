...
const dbMigrate = async () => {
    ...
    const btype1 = await BloodType.create({ Type: 'A' });
    const btype2 = await BloodType.create({ Type: 'B' });
    const btype3 = await BloodType.create({ Type: 'O' });
    const btype4 = await BloodType.create({ Type: 'AB' });

    const depart1 = await Department.create({ Name: 'Miner' });
    const depart2 = await Department.create({ Name: 'K3' });
    const depart3 = await Department.create({ Name: 'Research' });
